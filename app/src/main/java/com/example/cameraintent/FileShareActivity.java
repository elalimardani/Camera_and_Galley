...
public class FileShareActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mResultIntent = new Intent("com.example.cameraintent.ACTION_RETURN_FILES");
        ...
        mFileListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Uri fileUri = null;
                try{
                     fileUri = FileProvider.getUriForFile(FileShareActivity.this, "com.example.cameraintent", requestFile);
                } catch (Exception e){
                    e.printStackTrace();
                }
